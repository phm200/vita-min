...
# ClamAV installation
RUN wget -q -O /tmp/libclamav9.deb http://ftp.mx.debian.org/debian/pool/main/c/clamav/libclamav9_0.102.2+dfsg-0+deb10u1_amd64.deb \
 ...
 && dpkg -i /tmp/libclamav9.deb /tmp/clamav-base.deb /tmp/clamav.deb /tmp/clamdscan.deb
